...
original_body = doc.getObject(platename)
cloned_body = Draft.clone(original_body, False)
cloned_body.Label = "ClonedBody7"
cloname7=cloned_body.Name
...
original_body = doc.getObject(platename)
cloned_body = Draft.clone(original_body, False)
cloned_body.Label = "ClonedBody8"
cloname8=cloned_body.Name
...
original_body = doc.getObject(platename)
cloned_body = Draft.clone(original_body, False)
cloned_body.Label = "ClonedBody9"
cloname9=cloned_body.Name
...
body7 = doc.getObject(cloname7)
body8 = doc.getObject(cloname8)
body9 = doc.getObject(cloname9)
...
result_shape = result_shape.fuse(body7.Shape)
result_shape = result_shape.fuse(body8.Shape)
result_shape = result_shape.fuse(body9.Shape)
...
import Mesh
Mesh.export(objs,u"S:/Thesis/2dto3d/3D_Plate_xyz_C.stl")